...
for i = 1:length(EbNo_dB)
    ...
    %while no_errors <=100
        ...
        H = (randn(Nr,Nt) + 1i*randn(Nr,Nt))/sqrt(2*Nr);%Rayleigh fading channel model 
...
legend('ML','MMSE','ICD')
title(['Performance of MLD, MMSE and ICD for MIMO channel (410586010)'],'fontsize',12,'fontname','Helvetica');
fname = 'prob_11_03(410586010).png';
print (fname, '-dpng'); 