function [pb,ps]=cm_sm32_student(snr_in_dB) %[pb,ps]-->the returned matrix
...
for i=1:N
  ...
  % The correlation metrics are computed below.(inner product)
  c00=r(1)*s00(1)+r(2)*s00(2);
  c01=r(1)*s01(1)+r(2)*s01(2) ;             %<============== Fill here
  c10=r(1)*s10(1)+r(2)*s10(2) ;             %<============== Fill here
  c11=r(1)*s11(1)+r(2)*s11(2) ;             %<============== Fill here 
