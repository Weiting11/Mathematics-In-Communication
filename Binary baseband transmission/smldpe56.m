...
for i=1:N
  ...
  if (dsource(i)==0)
    r0= E + sgma*randn ;                %<=== AWGN, use randn ;E+n0
    r1= sgma*randn ;      		%<=== AWGN, use randn,  if the source output is "0";n1    
  else
    r0=  sgma*randn;                %<=== AWGN, use randn ;n0
    r1=  E + sgma*randn;  		   %<=== AWGN, use randn% if the source output is "1";E+n1
  end
  % Detector follows.
  if (r0>r1)
